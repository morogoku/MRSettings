...
public class SublimeMenuInflater {
    ...
    private static final String XML_CENTERED_TEXT = "CenteredText";
    ...
    private class MenuState {
        ...
        //grx build prop dependency

        private String grxBPrule;
        //
        ...
        public void addGroup() {
            ...
            //grx build prop rule
            menu.addGroup(groupId, groupIsCollapsible, groupIsCollapsed,
                    groupEnabled, groupVisible, groupCheckableBehavior, grxBPrule);
        ...
        public void readGroup(AttributeSet attrs) {
            ...
            //grx - build prop rule
            grxBPrule=null;
            grxBPrule = a.getString(R.styleable.SublimeMenuGroup_grxBPRule);
        ...
        public void readMenuItem(AttributeSet attrs, String tagName) {
            ...
            if(tagName.equals(XML_CENTERED_TEXT)) {
                int i = 0;
            }
            ...
            // itemBadgeText = a.getText(R.styleable.SublimeMenuGenericItem_badgeText); //grx
        ...
        private SublimeBaseMenuItem.ItemType getItemType(final String type) {
            switch (type) {
                ...
                case XML_CENTERED_TEXT:
                    return SublimeBaseMenuItem.ItemType.CENTERED; //grxgrx
        ...
        public void addItem() {
            ...
            if(!BPRulesUtils.isBPEnabled(grxBPrule)) {
                grxBPrule=null;
                return;
            }
            grxBPrule=null;
